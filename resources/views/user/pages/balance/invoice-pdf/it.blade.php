        ...
        <table style="margin-left: auto; margin-right: auto" width="550">
            <tr>
                ...
                <td>
                    ...
                    87010 Frascineto (Cosenza) Italia<br />
                    P.IVA 03249460787
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="right">
                    IMPORTO € {{ number_format($transaction->amount, 2) }}<br /><br />
                    TOTALE € {{ number_format($transaction->amount, 2) }}
                </td>
            </tr>
        </table>
    </div>
