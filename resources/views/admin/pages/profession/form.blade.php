@php
    ...
    if (isset($profession)) {
        $categoryId = old('category_id', $profession->category_id);
        $name_en = old('name_en', $profession->name_en);
        $name_es = old('name_es', $profession->name_es);
        $name_it = old('name_it', $profession->name_it);
        $description_en = old('description_en', $profession->description_en);
        $description_es = old('description_es', $profession->description_es);
        $description_it = old('description_it', $profession->description_it);
    } else {
...
<div class="row justify-content-center">
    <div class="col-lg-8">
        ...
        <div class="card">
            <form method="POST" action="{{ route('admin.prof.store') }}">
                @csrf
                @isset($profession)
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <select name="category_id" class="form-control">
                                @foreach ($prof_categories as $category)
