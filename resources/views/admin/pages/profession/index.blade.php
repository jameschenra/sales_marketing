    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title w-100 justify-content-between">
                ...
                <a href="{{ route('admin.prof.create') }}" class="btn btn-primary"><i class="flaticon2-plus-1"></i>@lang('main.Create')</a>
            </div>
        </div>
        ...
        <div class="card-body">
                ...
                <tbody>
                    @foreach ($professions as $key => $value)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.prof.edit', $value->id) }}" class="btn btn-sm btn-info">
                                    <span class="glyphicon glyphicon-edit"></span> {{ trans('main.Edit') }}
                                </a>
                            </td>
                            <td>
                                <a href="{{ route('admin.prof.delete', $value->id) }}" class="btn btn-sm btn-danger" id="btn-delete-item">
            ...
            <br />
            <div class="float-right">{{ $professions->links() }}</div>
