    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title w-100 justify-content-between">
                <h3 class="card-label">@lang('main.Offer') @lang('main.List')</h3>
                <a href="{{ route('admin.offer.create') }}" class="btn btn-primary"><i class="flaticon2-plus-1"></i>@lang('main.Create')</a>
            </div>
        </div>
            ...
            <table class="table table-bordered" id="kt_datatable">
                <thead>
                    <tr>
                        ...
                        <th>{{ trans('main.Received') }}</th>
                        <th>{{ trans('main.Expire At') }}</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $offer->expire_at }}</td>
                        <td>{{ $offer->created_at }}</td>
                        <td>
                            <a href="{{ route('admin.offer.edit', $offer->id) }}" class="btn btn-sm btn-info">
                                <span class="glyphicon glyphicon-edit"></span> {{ trans('main.Edit') }}
                            </a>
                        </td>
                        <td>
                            <a href="{{ route('admin.offer.delete', $offer->id) }}" class="btn btn-sm btn-danger" id="btn-delete-item">
