    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title w-100 justify-content-between">
                <h3 class="card-label">@lang('main.Sub Category')</h3>
                <a href="{{ route('admin.svcsubcat.create') }}" class="btn btn-primary"><i class="flaticon2-plus-1"></i>@lang('main.Create')</a>
            </div>
        </div>
        ...
        <div class="card-body">
                ...
                <tbody>
                    @foreach ($subCategories as $key => $value)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.svcsubcat.edit', $value->id) }}" class="btn btn-sm btn-info">
                                    <span class="glyphicon glyphicon-edit"></span> {{ trans('main.Edit') }}
                                </a>
                            </td>
                            <td>
                                <a href="{{ route('admin.svcsubcat.delete', $value->id) }}" class="btn btn-sm btn-danger" id="btn-delete-item">
            ...
            <br />
            <div class="float-right">{{ $subCategories->links() }}</div>
