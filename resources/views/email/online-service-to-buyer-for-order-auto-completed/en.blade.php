...
@section('email-content')
    ...
    <p>the service provided by <b>{{ $book->seller->name }}</b> has been automatically completed.</p>
    <br>
    ...
    <p>Go to the order page to see the completed service.</p>
    <br /><br />
    ...
    <p>
        We remember that the service, according to <b><a href="{{ route('user.terms') }}">Terms & Conditions</a></b> signed, if it is not confirmed within 48 hours from the delivery date, it is automatically approved and confirmed.
    </p>
    <br><br>
