...
@section('email-content')
    ...
    <p>el servicio ha sido completado por <b>{{ $book->seller->name }}</b> y necesita ser confirmado.</p>
    <br>
    ...
    <p>Ve a la página del pedido para confirmar o solicitar cambios.</p>
    <br /><br />
    ...
    <p>Si no respondes dentro de las 48 horas, de acuerdo con los <b><a href="{{ route('user.terms') }}">Términos y Condiciones</a></b> firmado, el servicio se confirmará automáticamente.</p>
    <br /><br />
