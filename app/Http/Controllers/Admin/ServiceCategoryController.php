...
class ServiceCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        $param['serviceCategories'] = ServiceCategory::orderBy('name_' . app()->getLocale())->paginate(PAGINATION_SIZE);

        return view('admin.pages.service-category.index')->with($param);
    }
    ...
    public function create()
    {
        ...
        return view('admin.pages.service-category.form')->with($param);
    }
    ...
    public function edit($id)
    {
        ...
        $param['icons'] = $this->icons;
        $param['service_category'] = ServiceCategory::find($id);
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            foreach (\LaravelLocalization::getSupportedLocales() as $localeCode => $properties) {
                ...
                $serviceCategory->$nameField = $request->input($nameField);
                $serviceCategory->$descField = $request->input($descField);
            }
