...
class Menu
{
    ...
    public static function renderVerMenu($item, $parent = null, $rec = 0, $singleItem = false)
    {
        ...
        if (isset($item['separator'])) {
            ...
            } elseif (config('layout.user.user.aside.menu.hide-root-icons') !== true && isset($item['icon']) && !empty($item['icon'])) {
            ...
            if (isset($item['submenu'])) {
                if (isset($item['root']) == false && config('layout.user.user.menu.aside.submenu.arrow') == 'plus-minus') {
                    echo '<i class="menu-arrow menu-arrow-pm"><span><span></span></span></i>';
                } elseif (isset($item['root']) == false && config('layout.user.user.menu.aside.submenu.arrow') == 'plus-minus-square') {
                    echo '<i class="menu-arrow menu-arrow-pm-square"><span><span></span></span></i>';
                } elseif (isset($item['root']) == false && config('layout.user.user.menu.aside.submenu.arrow') == 'plus-minus-circle') {
                    echo '<i class="menu-arrow menu-arrow-pm-circle"><span><span></span></span></i>';
                } else {
                    if (@$item['arrow'] !== false && config('layout.user.user.aside.menu.root-arrow') !== false) {
            ...
            if (isset($item['code'])) {
                ...
                if (isset($item['submenu']) && (!isset($item['arrow']) || $item['arrow'] != false)) {
                    ...
                    if (isset($item['root'])) {
                        ...
                        if (config('layout.user.user.header.menu.self.root-arrow') !== false) {
