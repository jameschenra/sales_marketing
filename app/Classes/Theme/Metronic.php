...
class Metronic
{
     ...
     */
    public static function initThemes($subdomain = 'admin')
    {
        $configFile = '';
        if($subdomain != 'admin') {
            $configFile = '.user';
        ...
        $themes[] = 'css/themes/layout/header/base/'.config('layout' . $configFile . '.header.self.theme').'.css';
        $themes[] = 'css/themes/layout/header/menu/'.config('layout' . $configFile . '.header.menu.desktop.submenu.theme').'.css';
        $themes[] = 'css/themes/layout/aside/'.config('layout' . $configFile . '.aside.self.theme').'.css';

        if (config($configFile . 'layout.aside.self.display')) {
            $themes[] = 'css/themes/layout/brand/'.config('layout' . $configFile . '.brand.self.theme').'.css';
        } else {
            $themes[] = 'css/themes/layout/brand/'.config('layout' . $configFile . '.header.self.theme').'.css';
        }
